...
export default function ArticlesSection({
  ...
  return (
    ...
    >
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16'>
        {articles.map((article, index) => (
          <motion.div
            ...
            className='bg-surface/80 dark:bg-surface/60 backdrop-blur-lg p-7 rounded-2xl border border-border/30 relative overflow-hidden group h-full flex flex-col'
            dir={direction}
          >
      ...
      <motion.div
        variants={itemVariants}
        className='text-center p-10 bg-surface/30 backdrop-blur-sm rounded-2xl border border-border/20'
      >
        ...
        <motion.a
          ...
          className='px-8 py-4 bg-gradient-to-r from-primary to-secondary text-white rounded-lg font-semibold inline-flex items-center gap-2 hover:shadow-lg transition-all duration-200'
        >
          <FaMedium />
          Follow on Medium
        </motion.a>
